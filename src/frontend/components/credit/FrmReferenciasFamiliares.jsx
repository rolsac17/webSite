...
const FrmReferenciasFamiliares = () => {
  return (
    <div className='container-strech'>
      <div className='grid'>
        {/* Agrupacion datos referencias familiares */}
        <div className='grid-12'>
          <h2 className='form__title-group'>Referencias familiares</h2>
...
export default FrmReferenciasFamiliares;
